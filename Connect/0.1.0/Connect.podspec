...
Pod::Spec.new do |s|
  s.name             = 'Connect'
  s.version          = '0.1.0'
  s.summary          = 'Calatrava.Bridge.Connect.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/manishkkatoch/Connect'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Manish Katoch' => 'manish.katoch@gmail.com' }
  s.source           = { :git => 'https://github.com/manishkkatoch/Connect.git', :tag => s.version.to_s }
